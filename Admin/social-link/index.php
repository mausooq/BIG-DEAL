...
// Stats
$totalSocialLinks = fetchScalar('SELECT COUNT(*) FROM social_links');
...
<body>
	...
	<div class="content">
		<?php require_once __DIR__ . '/../components/topbar.php'; renderAdminTopbar($_SESSION['admin_username'] ?? 'Admin', 'Search social media links...'); ?>
		...
		<div class="container-fluid p-4">
					...
					<div class="card card-stat">
						<div class="card-body d-flex align-items-center justify-content-between">
							<div>
								...
								<div class="h4 mb-0"><?php echo $totalSocialLinks; ?></div>
							</div>
							<div class="text-primary"><i class="fa-solid fa-share-nodes fa-lg"></i></div>
						</div>
					</div>
				</div>
				<div class="col-sm-6 col-xl-3">
			...
			<div class="toolbar mb-4">
				<div class="row-top">
					...
					<button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addSocialLinkModal">
						<i class="fa-solid fa-circle-plus me-1"></i>Add Social Link
					</button>
				</div>
			</div>
