...
<body>
	...
	<div class="content">
		<?php require_once __DIR__ . '/../components/topbar.php'; renderAdminTopbar($_SESSION['admin_username'] ?? 'Admin', 'Search blogs...'); ?>
			...
			<div class="toolbar mb-4">
				<div class="row-top">
					...
					<button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addBlogModal">
						<i class="fa-solid fa-circle-plus me-1"></i>Add Blog
					</button>
				</div>
			</div>
	...
	<script>
		...
		document.addEventListener('DOMContentLoaded', function(){
			...
			// Form validation for add blog
			const addBlogModal = document.getElementById('addBlogModal');
			if (addBlogModal) {
				const addForm = addBlogModal.querySelector('form');
				if (addForm) {
