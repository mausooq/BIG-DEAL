...
// Get states and districts for dropdowns
$mysqli = db();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	try {
		...
		$stmt && $stmt->bind_param('iss', $district_id, $name, $image_url);

		if (!$stmt || !$stmt->execute()) { throw new Exception('Failed to add city'); }
		$city_id = $mysqli->insert_id;
		$stmt->close();

		logActivity($mysqli, 'Added city', 'Name: ' . $name . ', District ID: ' . $district_id);
...
<body>
	...
	<div class="content">
		...
		<div class="container-fluid p-4">
			<div class="d-flex align-items-center justify-content-between mb-4">
				<div>
					<h2 class="h4 mb-1 fw-semibold">Add New City</h2>
					<p class="text-muted mb-0">Create a new city for location hierarchy</p>
				</div>
					...
					<div class="col-lg-12">
						<div class="card mb-4">
							<div class="card-body">
								...
								<div class="mb-3 mt-3">
									<label class="form-label">City Image (optional)</label>
	...
	<script>
		...
		document.getElementById('cityForm').addEventListener('submit', function(e){
			...
			if (name.length < 2 || !stateId || !districtId) { 
				e.preventDefault(); 
				alert('Please enter a valid city name and select both state and district'); 
			}
		});
	</script>
</body>
