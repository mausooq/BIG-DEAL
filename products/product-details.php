...
<body class="product-page">
      ...
      <div class=" col-md-4 property2-title">
        ...
        <div class="property-actions" style="margin-top: 20px;">
          <div class="btn-grp" style="display: flex; gap: 10px;">
            ...
            <button class="btn btn-whatsapp" onclick="whatsappProperty(<?php echo $property['id']; ?>)" style="background-color: #25D366; color: white; border: none; padding: 8px 16px; border-radius: 20px; display: flex; align-items: center; gap: 6px;">
  ...
  <script>
    ...
    function whatsappProperty(propertyId) {
        ...
        const propertyArea = '<?php echo number_format($property['area']); ?>';
        const propertyFurniture = '<?php echo addslashes($property['furniture_status']); ?>';
        const propertyLocation = '<?php echo addslashes($property['location']); ?>';
        const propertyDesc = '<?php echo addslashes(substr($property['description'], 0, 200)); ?>';
...
${propertyDesc}${propertyDesc.length >= 200 ? '...' : ''}
