...
<head>
  <meta charset="UTF-8" />
  <?php echo SEOConfig::generateMetaTags('about'); ?>
...
<style>
  ...
  echo SEOConfig::generateStructuredData('about');
  ?>
</head>
    ...
    <div class="centered">
      ...
      <h1>About Us</h1>
       <div class="breadcrumbs">
        <a href="<?php echo $site_base_path; ?>index.php">Home</a> > <span>About Us</span>
      </div>
